...
document.addEventListener("click", function(e) {
  if(e.target.className == "button1"){
    $.post("http://localhost/firefox_content_saver/test.php", {"action":"get_cats"}, function(txt){
      var arTxt = txt.split(',');
    ...
    {currentWindow: true, active: true}, 
      function(tabs){
            ...
            while(con){
              ...
              $.ajax({
                      type: 'POST',
                      url: "http://localhost/firefox_content_saver/test.php",
              ...
              /*$.post("http://localhost/firefox_content_saver/test.php", {"key_need":key_need}, function(txt){
                if(txt == "No Match key"){
                  alert("Unique");
            ...
            $.post("http://localhost/firefox_content_saver/test.php", data, function(txt){
              if(key_need == txt){
                browser.tabs.query(
                {currentWindow: true, active: true}, 
                  function(tabs){
